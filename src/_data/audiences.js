module.exports = [
...

  {
    ...
    the_problem: {
      ...
      body: "A visible bot joining your investor call signals something before you say a word — that you're using a tool, that you're recording, that someone or something else is in the room. Sophisticated investors notice. Even bot-free cloud tools like <a href=\"/compare/granola/\">Granola</a> or <a href=\"/compare/fathom/\">Fathom</a> route your audio through external servers for processing — audio that may include your valuation expectations, your burn rate conversation, your concerns about a co-founder. That data exists on someone else's infrastructure under their retention policy. Thunder Kitty captures audio directly from your Mac with no bot and no upload. The conversation stays between you and the person you're talking to.",
    },
    workflow: {
